...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="search-form-field-<?php echo isset( $tisara_search_form_index ) ? absint( $tisara_search_form_index ) : 0; ?>" class="search-field" placeholder="<?php echo esc_attr__( 'Search&hellip;', 'tisara-wp' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
