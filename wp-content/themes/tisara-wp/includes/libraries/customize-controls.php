...
class Tisara_Customize_Heading_Control extends WP_Customize_Control {
	public $type = 'tisara-heading';
...
class Tisara_Customize_Warning_Control extends WP_Customize_Control {
	public $type = 'tisara-warning';
	protected function content_template() {
		?>
...
class Tisara_Customize_Number_Control extends WP_Customize_Control {
	public $type = 'tisara-number';
...
class Tisara_Customize_Color_Control extends WP_Customize_Control {
	public $type = 'tisara-color';
	public function to_json() {
		parent::to_json();
	...
	protected function content_template() {
		...
		<input class="tisara-color-control" type="text" data-show-opacity="{{ data.show_opacity }}" data-palette="{{ data.palette }}" data-default-color="{{ data.default }}" value="{{ data.value }}" {{{ data.link }}} />
		<?php
	}
}

class Tisara_Customize_Slider_Control extends WP_Customize_Control {
	public $type = 'tisara-slider';
	public function to_json() {
		parent::to_json();
		$value = $this->value();
...
class Tisara_Customize_Radio_Buttonset_Control extends WP_Customize_Control {
	public $type = 'tisara-radio-buttonset';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class Tisara_Customize_Radio_Iconset_Control extends WP_Customize_Control {
	public $type = 'tisara-radio-iconset';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class Tisara_Customize_Radio_Image_Control extends WP_Customize_Control {
	public $type = 'tisara-radio-image';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class Tisara_Customize_Select2_Control extends WP_Customize_Control {
	public $type = 'tisara-select2';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class Tisara_Customize_Select2_Multiple_Control extends WP_Customize_Control {
	public $type = 'tisara-select2-multiple';
	public function to_json() {
		parent::to_json();
...
class Tisara_Customize_GoogleFonts_Control extends WP_Customize_Control {
	public $type = 'tisara-googlefonts';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class Tisara_Customize_Sortable_Control extends WP_Customize_Control {
	public $type = 'tisara-sortable';
	public function to_json() {
		parent::to_json();
		$this->json['default'] = $this->setting->default;
		if ( isset( $this->default ) ) {
		...
		<label class='tisara-sortable'>
			...
			<ul class="sortable">
				<# _.each( data.value, function( choiceID ) { #>
					<li {{{ data.inputAttrs }}} class='tisara-sortable-item' data-value='{{ choiceID }}'>
				...
				<# _.each( data.choices, function( choiceLabel, choiceID ) { #>
					<# if ( -1 === data.value.indexOf( choiceID ) ) { #>
						<li {{{ data.inputAttrs }}} class='tisara-sortable-item invisible' data-value='{{ choiceID }}'>
							<i class='dashicons dashicons-menu'></i>
							<i class="dashicons dashicons-visibility visibility"></i>
							{{{ data.choices[ choiceID ] }}}
						</li>
